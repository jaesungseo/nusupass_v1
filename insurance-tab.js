...
【중요 2 — 소재지】 등본 상단의 "현주소" 또는 "주소"는 세대 전체의 거주지입니다.
세대주가 누구든 상관없이, 세대원이 모두 같이 사는 주소이므로 이를 그대로 추출하세요.
"${policyInsuredName}"이 세대원이어도 같은 주소를 공유합니다.
...
JSON 출력 (정보 없으면 빈 문자열):
{
  ...
  "insured_registered_address": "등본 상단의 '현주소' (세대 전체 거주지 — 도로명/지번주소 전체. 세대주 기준 아니라 세대 공동 거주지)",
